    ...
    <div className="">
      ...
      <div className=" w-full xl:w-4/5 p-8 py-12 pb-28 mx-auto grid grid-cols-1 text-center justify-items-center lg:grid-cols-3 gap-6 ">
        {contents.map((content) => (
          <div className=" md:flex lg:block rounded-xl items-center md:w-[650px] md:h-[300px] w-[350px] lg:w-[350px] h-[450px] lg:h-[450px] shadow-xl cursor-pointer mx-4 transition-all duration-500 bg-white  hover:bg-primaryColor hover:scale-105">
