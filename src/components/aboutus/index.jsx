...
const AboutUs = () => {
  return (
    <div className='bg-white'>
      ...
      <div className='lg:w-1/2'><img className='w-3/4 shadow-2xl block mx-auto' src="./public/aboutus.jpg" alt="" /></div>
    ...
    <div className=' flex flex-col-reverse lg:flex-row mt:2 lg:mt-12 items-center py-12'>
      ...
      <div className='lg:w-1/2 '><img className='w-3/4 block shadow-2xl mx-auto' src="./public/aboutus.jpg" alt="" /></div>
    </div>
    </div>
